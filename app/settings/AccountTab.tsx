...
export function AccountTab() {
  ...
  if (isLoading) {
    return <div className="text-muted-foreground font-medium">Loading account details...</div>;
  }
  ...
  return (
    <div className="max-w-xl">
      ...
      <div className="mb-8 flex items-center gap-6">
        <div className="w-24 h-24 rounded-full bg-muted overflow-hidden flex items-center justify-center border-2 border-border shrink-0">
          {avatarUrl ? (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium w-full text-left group hover:text-primary transition-colors cursor-pointer"
          >
            ...
            <div className="space-y-3 pt-2">
              {SOCIAL_PLATFORMS.map((platform) => (
                <div key={platform.key} className="flex items-center gap-3">
                  <div
                    className="shrink-0 w-9 h-9 rounded-md bg-secondary flex items-center justify-center text-secondary-foreground"
