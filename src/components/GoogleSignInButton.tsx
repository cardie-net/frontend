...
/**
 * "Continue with Google" button that initiates the OAuth flow by
 * navigating to the backend's /authorize endpoint, which redirects
...
export default function GoogleSignInButton() {
  ...
  const handleGoogleSignIn = () => {
    ...
    // This endpoint redirects the browser directly to Google.
